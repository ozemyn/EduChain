...
public interface UserFollowRepository extends JpaRepository<UserFollow, Long> {
     ...
     * 获取用户在指定时间范围内的关注记录
     */
    List<UserFollow> findByFollowerIdAndCreatedAtBetween(Long followerId, LocalDateTime startTime, LocalDateTime endTime);

    /**
     * 获取用户在指定时间范围内的新粉丝
     */
    List<UserFollow> findByFollowingIdAndCreatedAtBetween(Long followingId, LocalDateTime startTime, LocalDateTime endTime);
     ...
     * 获取互相关注的用户关系
     */
    @Query("SELECT uf1 FROM UserFollow uf1 " +
