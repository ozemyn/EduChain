...
/** 用户关注控制器 提供用户之间的关注功能，包括关注、取消关注、查询关注列表等 支持关注状态查询、粉丝列表、关注列表等功能 */
@RestController
...
public class UserFollowController {
  ...
  /**
   * 关注用户接口 当前用户关注指定的其他用户
   *
   * @param followingId 被关注用户的ID
  ...
  /**
   * 检查关注状态接口 检查当前用户是否关注了指定的其他用户
   *
   * @param followingId 被关注用户的ID
   * @param request HTTP请求对象，用于获取当前用户ID
   * @return 关注状态，包含isFollowing布尔值
   */
  ...
  public ResponseEntity<Result<Map<String, Boolean>>> checkFollowStatus(
    ...
    try {
      ...
      return ResponseEntity.badRequest()
          .body(Result.error("CHECK_FOLLOW_STATUS_FAILED", e.getMessage()));
    }
  }
  ...
  public ResponseEntity<Result<Page<UserFollow>>> getFollowingList(
    ...
    try {
      ...
      return ResponseEntity.badRequest()
          .body(Result.error("GET_FOLLOWING_LIST_FAILED", e.getMessage()));
    }
  }
  ...
  public ResponseEntity<Result<Page<UserFollow>>> getFollowersList(
    ...
    try {
      ...
      return ResponseEntity.badRequest()
          .body(Result.error("GET_FOLLOWERS_LIST_FAILED", e.getMessage()));
    }
  }
  ...
  public ResponseEntity<Result<Page<UserFollow>>> getUserFollowingList(
    ...
    try {
      ...
      return ResponseEntity.badRequest()
          .body(Result.error("GET_USER_FOLLOWING_LIST_FAILED", e.getMessage()));
    }
  }
  ...
  public ResponseEntity<Result<Page<UserFollow>>> getUserFollowersList(
    ...
    try {
      ...
      return ResponseEntity.badRequest()
          .body(Result.error("GET_USER_FOLLOWERS_LIST_FAILED", e.getMessage()));
    }
  }
  ...
  public ResponseEntity<Result<Map<String, Long>>> getFollowStats(HttpServletRequest request) {
    try {
      ...
      return ResponseEntity.badRequest()
          .body(Result.error("GET_FOLLOW_STATS_FAILED", e.getMessage()));
    }
  }
  ...
  public ResponseEntity<Result<Map<String, Long>>> getUserFollowStats(
    ...
    try {
      ...
      return ResponseEntity.badRequest()
          .body(Result.error("GET_USER_FOLLOW_STATS_FAILED", e.getMessage()));
    }
  }
  ...
  public ResponseEntity<Result<List<UserFollow>>> getMutualFollows(HttpServletRequest request) {
    try {
      ...
      return ResponseEntity.badRequest()
          .body(Result.error("GET_MUTUAL_FOLLOWS_FAILED", e.getMessage()));
    }
  }
  ...
  public ResponseEntity<Result<List<Long>>> getRecommendedUsers(
    ...
    try {
      ...
      return ResponseEntity.badRequest()
          .body(Result.error("GET_RECOMMENDED_USERS_FAILED", e.getMessage()));
    }
  }
  ...
  public ResponseEntity<Result<List<UserFollow>>> getRecentFollowing(
    ...
    try {
      ...
      return ResponseEntity.badRequest()
          .body(Result.error("GET_RECENT_FOLLOWING_FAILED", e.getMessage()));
    }
  }
  ...
  public ResponseEntity<Result<List<UserFollow>>> getRecentFollowers(
    ...
    try {
      ...
      return ResponseEntity.badRequest()
          .body(Result.error("GET_RECENT_FOLLOWERS_FAILED", e.getMessage()));
    }
  }
  ...
  public ResponseEntity<Result<Map<Long, Boolean>>> batchCheckFollowing(
    ...
    try {
      ...
      return ResponseEntity.badRequest()
          .body(Result.error("BATCH_CHECK_FOLLOWING_FAILED", e.getMessage()));
    }
  }
  ...
  public ResponseEntity<Result<List<Map<String, Object>>>> getFollowingActivities(
    ...
    try {
      ...
      List<Map<String, Object>> activities =
          userFollowService.getFollowingActivities(userId, since, limit);
      return ResponseEntity.ok(Result.success(activities));
    } catch (Exception e) {
      logger.error("获取关注动态失败", e);
      return ResponseEntity.badRequest()
          .body(Result.error("GET_FOLLOWING_ACTIVITIES_FAILED", e.getMessage()));
    }
  }
  ...
  public ResponseEntity<Result<List<Map<String, Object>>>> getPopularUsers(
    ...
    try {
      ...
      return ResponseEntity.badRequest()
          .body(Result.error("GET_POPULAR_USERS_FAILED", e.getMessage()));
    }
  }
  ...
  public ResponseEntity<Result<List<Map<String, Object>>>> getActiveFollowers(
    ...
    try {
      ...
      return ResponseEntity.badRequest()
          .body(Result.error("GET_ACTIVE_FOLLOWERS_FAILED", e.getMessage()));
    }
  }
  ...
  public ResponseEntity<Result<List<UserFollow>>> getRecentFollowActivities(
    ...
    try {
      ...
      return ResponseEntity.badRequest()
          .body(Result.error("GET_RECENT_FOLLOW_ACTIVITIES_FAILED", e.getMessage()));
    }
  }
  ...
  public ResponseEntity<Result<Map<String, Long>>> getSystemFollowStats() {
    try {
      ...
      return ResponseEntity.badRequest()
          .body(Result.error("GET_SYSTEM_FOLLOW_STATS_FAILED", e.getMessage()));
    }
  }
}
