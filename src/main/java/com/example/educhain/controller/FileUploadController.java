...
public class FileUploadController {
    ...
    public ResponseEntity<Result<List<FileUpload>>> uploadFiles(
        ...
        Long userId = getUserId(authentication);
        List<FileUpload> result = fileUploadService.uploadFiles(files, userId, knowledgeId, description);
    ...
    public ResponseEntity<Result<List<FileUpload>>> getKnowledgeFiles(@PathVariable Long knowledgeId) {
    ...
    public ResponseEntity<Result<FileUploadService.UserFileStats>> getUserFileStats(@PathVariable Long userId) {
