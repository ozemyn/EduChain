...
public class RecommendationController {
  ...
  public Result<List<SearchResultDTO>> getRecommendations(
    ...
    try {
      ...
      logger.error("获取推荐内容失败: type={}, userId={}, error={}", type, userId, e.getMessage(), e);
  ...
  public Result<List<SearchResultDTO>> getTrendingRecommendations(
    ...
    try {
      ...
      logger.error("获取趋势推荐失败: userId={}, error={}", userId, e.getMessage(), e);
  ...
  public Result<List<SearchResultDTO>> getLatestRecommendations(
    ...
    try {
      ...
      logger.error("获取最新推荐失败: userId={}, error={}", userId, e.getMessage(), e);
    ...
    try {
      ...
      if (authentication != null
          ...
          && authentication.getPrincipal()
              instanceof CustomUserDetailsService.CustomUserPrincipal) {
