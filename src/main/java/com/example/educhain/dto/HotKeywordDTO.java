...
public class HotKeywordDTO {
    ...
    // 构造函数 - 从实体转换
    public HotKeywordDTO(Long id, String keyword, Long searchCount, Long resultCount, 
                        Long clickCount, Double trendScore, Long dailyCount, 
                        LocalDateTime lastSearchedAt, Long categoryId, String categoryName) {
        this.id = id;
        this.keyword = keyword;
        this.searchCount = searchCount;
        this.resultCount = resultCount;
