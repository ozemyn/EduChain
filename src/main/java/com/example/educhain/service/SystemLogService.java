...
public interface SystemLogService {
     ...
     * 记录操作日志
     */
    void logOperation(Long userId, String username, String operation, String description,
     ...
     * 记录错误日志
     */
    void logError(String operation, String description, String exception,
                  String ipAddress, String requestUrl, String requestMethod);

    /**
     * 记录安全日志
     */
    void logSecurity(Long userId, String username, String operation, String description,
                    String ipAddress, String userAgent, String requestUrl);

    /**
     * 记录性能日志
     */
    void logPerformance(String operation, String description, Long executionTime,
     ...
     * 查询日志列表
     */
    Page<SystemLog> findLogs(SystemLog.LogType logType, SystemLog.LogLevel level,
     ...
     * 导出日志数据
     */
    List<SystemLog> exportLogs(SystemLog.LogType logType, LocalDateTime startTime, LocalDateTime endTime);
}