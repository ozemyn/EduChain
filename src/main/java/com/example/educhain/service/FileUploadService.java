...
public interface FileUploadService {
     ...
     * 上传多个文件
     */
    List<FileUpload> uploadFiles(List<MultipartFile> files, Long uploaderId, Long knowledgeId, String description);
    ...
    class FileUploadStats {
        ...
        public FileUploadStats(Long totalFiles, Long totalSize, Long totalDownloads,
                              Long imageCount, Long videoCount, Long documentCount, Long otherCount) {
