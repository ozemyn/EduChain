...
public interface RecommendationService {
     ...
     * @return 推荐内容列表
     */
    List<SearchResultDTO> getBehaviorBasedRecommendations(Long userId, String behaviorType, int limit);
     ...
     * @param position 推荐位置
     */
    void recordRecommendationClick(Long userId, Long knowledgeId, String recommendationType, Integer position);
