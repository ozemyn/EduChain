...
public interface KnowledgeItemService {
     ...
     * 创建知识内容（带文件上传）
     */
    KnowledgeItemDTO createWithFiles(CreateKnowledgeRequest request, List<MultipartFile> files, Long uploaderId);
     ...
     * 更新知识内容（带文件上传）
     */
    KnowledgeItemDTO updateWithFiles(Long id, UpdateKnowledgeRequest request, List<MultipartFile> files, Long editorId);
     ...
     * 分页查询知识内容（包含用户互动状态）
     */
    Page<KnowledgeItemDTO> findAllWithUserStatus(Pageable pageable, KnowledgeFilter filter, Long userId);
     ...
     * 恢复到指定版本
     */
    KnowledgeItemDTO restoreToVersion(Long knowledgeId, Integer versionNumber, Long operatorId, String changeSummary);
    ...
    class VersionDiff {
        ...
        public KnowledgeVersion getVersion1() { return version1; }
        public void setVersion1(KnowledgeVersion version1) { this.version1 = version1; }

        public KnowledgeVersion getVersion2() { return version2; }
        public void setVersion2(KnowledgeVersion version2) { this.version2 = version2; }

        public List<String> getTitleDiff() { return titleDiff; }
        public void setTitleDiff(List<String> titleDiff) { this.titleDiff = titleDiff; }

        public List<String> getContentDiff() { return contentDiff; }
        public void setContentDiff(List<String> contentDiff) { this.contentDiff = contentDiff; }

        public List<String> getTagsDiff() { return tagsDiff; }
        public void setTagsDiff(List<String> tagsDiff) { this.tagsDiff = tagsDiff; }
    }
    ...
    class KnowledgeStats {
        ...
        public KnowledgeStats(Long totalCount, Long publishedCount, Long draftCount, Long deletedCount,
                             Long totalViews, Long totalLikes, Long totalFavorites, Long totalComments) {
    ...
    class UserKnowledgeStats {
        ...
        public UserKnowledgeStats(Long publishedCount, Long draftCount, Long totalViews,
                                 Long totalLikes, Long totalFavorites, Long totalComments,
