...
public class CommunityServiceImpl implements CommunityService {
    ...
    private static final String[] TAG_COLORS = {"blue", "cyan", "green", "purple", "orange", "red", "magenta", "lime"};
    ...
    public List<DiscussionDTO> getHotDiscussions(Integer limit) {
        ...
        List<KnowledgeItem> items = knowledgeItemRepository.findByStatusOrderByCreatedAtDesc(1, pageable);
    ...
    public List<DiscussionDTO> getTrendingDiscussions(Integer limit) {
        ...
        List<KnowledgeItem> items = knowledgeItemRepository
                .findByStatusAndCreatedAtAfterOrderByCreatedAtDesc(1, sevenDaysAgo, pageable);
    ...
    public List<ActiveUserDTO> getActiveUsers(Integer limit) {
        ...
        for (UserStats stats : userStatsList) {
            ...
            if (user != null) {
                activeUsers.add(ActiveUserDTO.builder()
                        .id(user.getId())
    ...
    public List<HotTopicDTO> getHotTopics(Integer limit) {
        ...
        for (int i = 0; i < tags.size(); i++) {
            Tag tag = tags.get(i);
            hotTopics.add(HotTopicDTO.builder()
                    .name(tag.getName())
