...
export const mockTickets: Ticket[] = [
  {
    ...
    updateTime: '2024-12-07 14:20:00',
    description: '尝试上传PDF文件时显示格式不支持的错误，文件大小为5MB，格式确认无误。已尝试多次上传，均显示相同错误信息。',
    steps: '1. 点击"发布内容"按钮\n2. 选择PDF文件\n3. 点击上传\n4. 显示"格式不支持"错误',
    email: 'zhangsan@example.com',
    phone: '13800138001',
    expectedResponse: 'urgent',
    attachments: ['error-screenshot.png'],
    response: '我们已经收到您的问题，正在技术团队处理中。初步判断可能是服务器配置问题，预计今日内修复。',
    userId: 2,
    assignedTo: 1
  },
  {
    ...
    priority: 'high',
    status: 'resolved',
    createTime: '2024-12-06 15:45:00',
    updateTime: '2024-12-07 09:15:00',
    description: '提交存证后一直显示处理中状态，已经超过24小时。文档是重要的学术论文，急需完成存证。',
    email: 'lisi@example.com',
    expectedResponse: 'immediate',
    response: '问题已解决，存证服务已恢复正常。您的文件已成功存证，存证编号：BC20241207001。',
    userId: 3,
    assignedTo: 1,
    resolvedAt: '2024-12-07 09:15:00'
  },
  {
    id: 'TK20241205003',
    title: '账户余额显示异常',
    ...
    priority: 'low',
    status: 'pending',
    createTime: '2024-12-05 09:20:00',
    updateTime: '2024-12-05 09:20:00',
    description: '充值后余额没有更新，但是扣费记录正常。充值金额为100元，支付宝支付成功。',
  ...
  },
  {
    ...
    priority: 'medium',
    status: 'resolved',
    createTime: '2024-12-04 16:30:00',
    updateTime: '2024-12-05 08:45:00',
    description: '点击忘记密码后，邮箱没有收到重置邮件。已检查垃圾邮件箱，确认邮箱地址正确。',
    email: 'zhaoliu@example.com',
    expectedResponse: 'urgent',
    response: '邮件服务已修复，重置邮件已重新发送。请检查您的邮箱并按照邮件指引重置密码。',
    userId: 5,
    assignedTo: 1,
    resolvedAt: '2024-12-05 08:45:00'
  },
  {
    id: 'TK20241203005',
    title: '页面加载缓慢',
    ...
    priority: 'low',
    status: 'processing',
    createTime: '2024-12-03 14:15:00',
    updateTime: '2024-12-04 10:30:00',
    description: '最近几天发现页面加载速度明显变慢，特别是知识列表页面，需要等待10秒以上才能完全加载。',
    email: 'sunqi@example.com',
    expectedResponse: 'normal',
    response: '我们已经注意到这个问题，正在优化服务器性能和数据库查询。预计本周内完成优化。',
    userId: 6,
    assignedTo: 1
  },
  {
    ...
    updateTime: '2024-12-03 16:20:00',
    description: '修改个人资料后点击保存，显示保存成功，但刷新页面后发现修改没有生效。',
    email: 'zhouba@example.com',
    expectedResponse: 'urgent',
    response: '问题已修复，个人资料保存功能已恢复正常。感谢您的反馈。',
    userId: 7,
    assignedTo: 1,
    resolvedAt: '2024-12-03 15:30:00',
    closedAt: '2024-12-03 16:20:00'
  },
  {
    id: 'TK20241201007',
    title: '搜索功能返回结果不准确',
    ...
    priority: 'low',
    status: 'resolved',
    createTime: '2024-12-01 09:45:00',
    updateTime: '2024-12-02 14:10:00',
    description: '使用搜索功能时，输入关键词返回的结果与预期不符，很多相关内容没有显示在结果中。',
    email: 'wujiu@example.com',
    expectedResponse: 'normal',
    response: '搜索算法已优化，相关性排序已改进。现在搜索结果应该更加准确。',
    userId: 8,
    assignedTo: 1,
    resolvedAt: '2024-12-02 14:10:00'
  },
  {
    id: 'TK20241130008',
    title: '移动端界面显示异常',
    ...
    priority: 'medium',
    status: 'processing',
    createTime: '2024-11-30 20:30:00',
    updateTime: '2024-12-01 09:00:00',
    description: '在手机浏览器中访问网站，部分按钮和文字显示不完整，影响正常使用。使用的是iPhone Safari浏览器。',
  ...
  },
  {
    ...
    priority: 'low',
    status: 'pending',
    createTime: '2024-11-29 13:20:00',
    updateTime: '2024-11-29 13:20:00',
    description: '已关闭邮件通知，但仍然收到系统邮件。希望能够完全关闭不必要的通知。',
  ...
  },
  {
    ...
    updateTime: '2024-11-30 10:15:00',
    description: '提交的内容已经等待审核3天了，希望能够加快审核速度。内容是原创技术文章。',
    email: 'huanger@example.com',
    expectedResponse: 'urgent',
    response: '您的内容已通过审核并发布。我们已优化审核流程，后续审核时间将缩短至24小时内。',
    userId: 11,
    assignedTo: 1,
    resolvedAt: '2024-11-30 10:15:00'
  },
  {
    id: 'TK20241127011',
    title: '发票申请功能找不到',
    ...
    updateTime: '2024-11-28 09:20:00',
    description: '需要申请充值发票，但在系统中找不到相关功能入口。',
    email: 'linsan@example.com',
    expectedResponse: 'normal',
    response: '发票申请功能位于"个人中心"->"账单管理"->"发票申请"。我们已在帮助文档中添加相关说明。',
    userId: 12,
    assignedTo: 1,
    resolvedAt: '2024-11-28 09:20:00'
  },
  {
    id: 'TK20241126012',
    title: '关注功能异常',
    ...
    priority: 'medium',
    status: 'closed',
    createTime: '2024-11-26 11:15:00',
    updateTime: '2024-11-27 15:40:00',
    description: '点击关注其他用户后，关注列表中没有显示，但对方的粉丝数量增加了。',
    email: 'xusi@example.com',
    expectedResponse: 'urgent',
    response: '关注功能的显示问题已修复，您的关注列表已同步更新。',
    userId: 13,
    assignedTo: 1,
    resolvedAt: '2024-11-27 14:30:00',
    closedAt: '2024-11-27 15:40:00'
  }
];
...
// 创建新工单
export const createTicket = (ticketData: Omit<Ticket, 'id' | 'createTime' | 'updateTime' | 'status'>): Ticket => {
...
// 更新工单状态
export const updateTicketStatus = (ticketId: string, status: string, response?: string): boolean => {
